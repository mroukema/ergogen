...
module.exports = {
    ...
    body: p => {
      ...
      ` +
        (p.param.reverse ? commonFront + commonBack : commonBack);
      ...
      const [smdFront, smdBack] =
        [`
          ${''/* SMD pads on front side */}
        ...
        `];
      const smd = p.param.reverse ? smdFront + smdBack : smdBack;
      const suffix = `
        )
      `;
      ...
      switch (p.param.mode) {
        case Mode.Dual:
          return common + smd + tht + suffix;
        case Mode.Smd:
          return common + smd + suffix;
        case Mode.Tht:
          return common + tht + suffix;
      }
    }
}
